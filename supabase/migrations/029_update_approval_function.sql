-- Migration: Update Business Approval Function to Extract All Details
-- This updates the approve_business_signup function to extract and store
-- all business details from the business_config JSONB field
...
-- Add comment
COMMENT ON FUNCTION approve_business_signup IS 'Approves a business signup request and creates business with full details extracted from business_config';

-- Success message
DO $$
BEGIN
  RAISE NOTICE 'Approval function updated successfully!';
  RAISE NOTICE '✅ Now extracts all business details from business_config';
END $$;
