-- Create business_signup_requests table
...
CREATE INDEX IF NOT EXISTS idx_business_signup_requests_status ON business_signup_requests(status);
CREATE INDEX IF NOT EXISTS idx_business_signup_requests_email ON business_signup_requests(email);
CREATE INDEX IF NOT EXISTS idx_business_signup_requests_created_at ON business_signup_requests(created_at);
